...
<div class="row">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Hasta Formu</h4>
        </div>
        <div class="card-body">
            <p class="text-muted">Yeni hastayı bu ekran üzerinden ekleyebilirsiniz, yanında <span class="text-danger">*</span> olan bilgiler doldurulmak zorundadır.</p>
